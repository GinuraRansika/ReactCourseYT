...
function App() {
    ...
    */
    ...
    /*
        ! To avoid above problems React team gives us a really nice hook called useEffect()
            ? in the documentation this is called the effect hook and 
            ? (it's like a tool reach has given developers to use sort of like a blank canvas that allows us to interact outside react ecosystem)
            ? ecosystem - which again mostly just consists of state, props and the user interface that it puts on the page
            * useEffect() like a tool that allows us to synchronize react state with those outside systems like our local storage or an API
    */
